document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateLeagues(selectedCountry, initialLeague) {
        const leagueSelect = document.getElementById('league-select');
        ...
        // Pre-select the initial league if available
        if (initialLeague) {
            const initialLeagueOption = leagueSelect.querySelector(`option[value="${initialLeague}"]`);
            if (initialLeagueOption) {
                initialLeagueOption.selected = true;
            }
        }
    }
    ...
    countrySelect.addEventListener('change', function() {
        ...
        const initialLeague = leagueSelect.value; // Get the initial league before repopulating
        populateLeagues(selectedCountry, initialLeague);
    });
    ...
    populateLeagues(initialCountry, initialLeague);

    // Limit transfer budget input to four digits
